...
namespace SafetyTourism.Controllers
{
    public class SurtosOcurrenciasController : Controller
    {
        ...
        {
            ViewData["DestinoTuristicoID"] = new SelectList(_context.DestinoTuristicos, "DestinoTuristicoID", "DestinoTuristicoID");
            ViewData["SurtosEpidemiologicoID"] = new SelectList(_context.SurtosEpidemiologicos, "SurtosEpidemiologicoID", "SurtosEpidemiologicoID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("SurtosOcurrenciaID,DataInicio,Relatorio,SurtosEpidemiologicoID,DestinoTuristicoID")] SurtosOcurrencia surtosOcurrencia)
        {
            ...
            ViewData["DestinoTuristicoID"] = new SelectList(_context.DestinoTuristicos, "DestinoTuristicoID", "DestinoTuristicoID", surtosOcurrencia.DestinoTuristicoID);
            ViewData["SurtosEpidemiologicoID"] = new SelectList(_context.SurtosEpidemiologicos, "SurtosEpidemiologicoID", "SurtosEpidemiologicoID", surtosOcurrencia.SurtosEpidemiologicoID);
            return View(surtosOcurrencia);
        }
