...
namespace SafetyTourism.Controllers
{
    ...
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(SafetyTourismdb context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuncionarioID,NomeFuncionario,MailFuncionario")] Funcionario funcionario)
        {
