...
namespace SafetyTourismPaulo.Controllers
{
    public class RecomendacoesController : Controller
    {
        ...
        public RecomendacoesController(SafetyTourism context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RecomendacoeID,DataRegisto,Relatorio")] Recomendacoe recomendacoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecomendacoeID,DataRegisto,Relatorio")] Recomendacoe recomendacoe)
        {
