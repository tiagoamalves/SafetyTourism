...
namespace SafetyTourismPaulo.Controllers
{
    public class SurtosOcurrenciasController : Controller
    {
        ...
        public SurtosOcurrenciasController(SafetyTourism context)
        {
            _context = context;
        }
        ...
        {
            var safetyTourism = _context.SurtosOcurrencias.Include(s => s.DestinoTuristico).Include(s => s.SurtosEpidemiologico);
            return View(await safetyTourism.ToListAsync());
        }
        ...
        {
            ViewData["DestinoTuristicoID"] = new SelectList(_context.DestinoTuristico, "DestinoTuristicoID", "DestinoTuristicoID");
            ViewData["SurtosEpidemiologicoID"] = new SelectList(_context.SurtosEpidemiologico, "SurtosEpidemiologicoID", "SurtosEpidemiologicoID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("SurtosOcurrenciaID,DataInicio,Relatorio,SurtosEpidemiologicoID,DestinoTuristicoID")] SurtosOcurrencia surtosOcurrencia)
        {
            ...
            ViewData["DestinoTuristicoID"] = new SelectList(_context.DestinoTuristico, "DestinoTuristicoID", "DestinoTuristicoID", surtosOcurrencia.DestinoTuristicoID);
            ViewData["SurtosEpidemiologicoID"] = new SelectList(_context.SurtosEpidemiologico, "SurtosEpidemiologicoID", "SurtosEpidemiologicoID", surtosOcurrencia.SurtosEpidemiologicoID);
            return View(surtosOcurrencia);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SurtosOcurrenciaID,DataInicio,Relatorio,SurtosEpidemiologicoID,DestinoTuristicoID")] SurtosOcurrencia surtosOcurrencia)
        {
